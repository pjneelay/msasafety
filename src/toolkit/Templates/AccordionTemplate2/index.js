    ...
    <div id="mainContainer" className="container">
      ...
      <Wrapper className={`player-container ` + extraClass}>
        ...
        <div className='container' style={{width: "50vw"}}>
           {(secondaryOptions.length >3)? <div className='buttonBar'><div className='leftButton' onClick={() => scroll(-90)} style={{overflowX:'unset',position:'fixed',zIndex:'2000',marginTop:'2rem',borderRadius:'50%',borderColor:'white',backgroundColor:'white',padding:'8px',boxShadow:'0 10px 6px -6px grey',width:'30px',height:'30px'}}><LeftOutlined style={{ fontSize: '16px', color: ' #00A94E',verticalAlign:'super' }} /></div><div style={{display:'flex',justifyContent:'flex-end'}}><div className='rightButton' onClick={() => scroll(90)} style={{overflowX:'unset',position:'fixed',zIndex:'2000',marginTop:'2rem',borderRadius:'50%',borderColor:'white',backgroundColor:'white',padding:'8px',boxShadow:'0 10px 6px -6px grey',width:'30px',height:'30px'}}><RightOutlined style={{ fontSize: '16px', color: ' #00A94E',verticalAlign:'super' }} /></div></div></div> :null }
